...
LastUpdate: $Date: 2009-12-08 20:56:07 +0000 (Tue, 08 Dec 2009) $
]]
...
RatingBuster.version = "1.4.8 (r"..gsub("$Revision: 271 $", "(%d+)", "%1")..")"
RatingBuster.date = gsub("$Date: 2009-12-08 20:56:07 +0000 (Tue, 08 Dec 2009) $", "^.-(%d%d%d%d%-%d%d%-%d%d).-$", "%1")
